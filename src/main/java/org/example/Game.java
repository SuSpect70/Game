...
public class Game extends JFrame {
    ...
    public static void main(String[] args) throws IOException {
        backround = ImageIO.read(new FileInputStream("src/main/resources/images/FON.jpg"));
        game_over = ImageIO.read(new FileInputStream("src/main/resources/images/nigo.jpg"));
        drop = ImageIO.read(new FileInputStream("src/main/resources/images/vishenka.png"));
